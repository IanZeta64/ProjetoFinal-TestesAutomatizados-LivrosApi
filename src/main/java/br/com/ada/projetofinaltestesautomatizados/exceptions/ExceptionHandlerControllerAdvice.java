...
public class ExceptionHandlerControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleLivroNaoEncontradoException(LivroNaoEncontradoException ex) {
        String errorMessage = ex.getMessage();
        HttpStatus httpStatus = HttpStatus.NOT_FOUND;
        return new ResponseEntity<>(errorMessage, httpStatus);
    }
    @ExceptionHandler(LivroDuplicadoException.class)
    public ResponseEntity<Object> handleLivroDuplicadoException(LivroDuplicadoException ex) {
        String errorMessage = ex.getMessage();
